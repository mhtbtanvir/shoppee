...
const Register = ({ isLoading = false, error = null }) => {
  return (
    ...
    <h2 className="text-3xl flex items-center justify-center font-semibold text-slate-500 ">
        Hello Beautifull
    </h2>
        ...
        <form className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              autoComplete="name"
              className="w-full pl-10 pr-4 py-3 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all"
            />
          </div>
